          ...
          const parsed: Product[] = results.data
            .map((row) => {
              ...
              return {
                ...
                IMAGEN_PRINCIPAL: getColumn(["IMG_URL_1", "IMAGEN_PRINCIPAL", "IMAGEN_PRIM", "imagen_principal", "IMAGE"]),
                IMAGEN_2: getColumn(["IMG_URL_2", "IMAGEN_2", "imagen_2", "IMAGE_2"]),
                IMAGEN_3: getColumn(["IMG_URL_3", "IMAGEN_3", "imagen_3", "IMAGE_3"]),
                IMAGEN_4: getColumn(["IMG_URL_4", "IMAGEN_4", "imagen_4", "IMAGE_4"]),
